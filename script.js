// 🔱 LOKRAJ AWASTHI - DIRECT ENGINE VIA INLINE INJECTION 🔱

const pools = {
    class10_science: [{ question: "What is the acceleration due to gravity (g) at the poles of the Earth?", options: ["9.78 m/s²", "9.83 m/s²", "9.80 m/s²", "6.67 m/s²"], correct: 1 }, { question: "Which blood vessel carries oxygenated blood from the lungs to the heart?", options: ["Pulmonary Artery", "Pulmonary Vein", "Vena Cava", "Aorta"], correct: 1 }],
    class10_optmath: [{ question: "If vector A = (2, 3) and vector B = (4, 1), what is the value of A + B?", options: ["(6, 4)", "(2, 2)", "(8, 3)", "(6, 2)"], correct: 0 }],
    class10_computer: [{ question: "Which computer topology requires a central controller or hub?", options: ["Bus Topology", "Star Topology", "Ring Topology", "Mesh Topology"], correct: 1 }],
    class11_computer: [{ question: "Which of the following is the brain of a computer system?", options: ["ALU", "Memory", "CPU", "Control Unit"], correct: 2 }],
    class11_physics: [{ question: "What is the dimensional formula for Work Done or Energy?", options: ["MLT⁻²", "ML²T⁻²", "ML²T⁻¹", "M⁻¹L³T⁻²"], correct: 1 }],
    class11_chemistry: [{ question: "What is the shape of an s-orbital?", options: ["Dumbbell", "Spherical", "Double Dumbbell", "Linear"], correct: 1 }],
    class11_math: [{ question: "What is the value of i² in complex numbers?", options: ["1", "-1", "0", "under-root 1"], correct: 1 }],
    nepal_bhugol: [{ question: "Which is the largest lake in Nepal?", options: ["Phewa Lake", "Rara Lake", "Tilicho Lake", "Shey-Phoksundo Lake"], correct: 1 }],
    world_bhugol: [{ question: "Which is the longest river in the world?", options: ["Amazon River", "Nile River", "Yangtze River", "Mississippi River"], correct: 1 }],
    nepal_itihas: [{ question: "Which treaty officially ended the Anglo-Nepalese War (1814-1816)?", options: ["Sugauli Treaty", "Treaty of Kathmandu", "Lal Mohar Treaty", "Segauli Alliance"], correct: 0 }],
    world_itihas: [{ question: "In which year did World War I officially begin?", options: ["1912", "1914", "1918", "1939"], correct: 1 }],
    loksewa_gk: [{ question: "According to the Constitution of Nepal, who holds residual powers?", options: ["Federal Parliament", "Federal Executive (Council of Ministers)", "Supreme Court", "Provincial Assembly"], correct: 1 }],
    science_out: [{ question: "What is the approximate time taken by sunlight to reach the Earth?", options: ["500 seconds", "800 seconds", "300 seconds", "100 seconds"], correct: 0 }]
};

// Auto Inflation Engine
...
function playTickAlarm() {
    ...
    } catch (e) { console.log("Audio logic synced."); }
}
